...
class BlenderMVS(Dataset):
    """NSVF Generic Dataset."""
    def __init__(self, datadir, split='train', downsample=1.0, wh=(768,576), is_stack=False, **kwargs):
    ...
    def read_meta(self):
        ...
        self.intrinsics[:2] *= (np.array(self.img_wh)/np.array((768,576))).reshape(2,1)
